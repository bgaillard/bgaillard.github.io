...
layout: post
title: You have mail.
summary: Learn how to manage system mails on Linux using Thunderbird. Set up an IMAP server with imap4d and configure Thunderbird to read local mailboxes, ensuring you never miss important notifications.
ShowToc: true
TocOpen: true
---
...
![Import Mkcert Root CA certificate - 1](thunderbird-import-mkcert-root-ca-certificate-1.png)
...
![Import Mkcert Root CA certificate - 2](thunderbird-import-mkcert-root-ca-certificate-2.png)

After import you should see the new imported Root CA certificate in the list.

![Import Mkcert Root CA certificate - 3](thunderbird-import-mkcert-root-ca-certificate-3.png)
...
![Add Account - 1](thunderbird-add-account-1.png)
...
![Add Account - 2](thunderbird-add-account-2.png)
...
![Add Account - 3](thunderbird-add-account-3.png)
...
![Add Account - 4](thunderbird-add-account-4.png)
...
![`.localhost` Hostname empty or invalid](troubleshooting-localhost-hostname-empty-or-invalid.png)
